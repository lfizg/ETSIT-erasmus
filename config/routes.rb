Rails.application.routes.draw do
  ...
  # For details on the DSL available within this file, see http://guides.rubyonrails.org/routing.html
    ...
    get 'generate_acceptance_letter_spa/:user', to: "user#generate_acceptance_letter_spa"
    get 'generate_acceptance_letters_spa', to: "user#generate_acceptance_letters_spa"
