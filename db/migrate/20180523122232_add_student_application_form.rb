...
#			t.integer  :singleton_guard
			...
			t.string :mobility_programmes,  default: ["Erasmus+ Studies", "Erasmus+ Placement", "Magalhães", "Bilateral Agreement", "Visiting Student", "SICUE/SENECA", "Traineeship", "Research Stay/Project", "Other"].inspect
			t.timestamps
		end
