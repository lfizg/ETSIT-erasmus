...
ActiveRecord::Schema.define(version: 2018_12_05_201423) do
  ...
  create_table "project_settings", force: :cascade do |t|
    ...
    t.string "mobility_programmes", default: "[\"Erasmus+ Studies\", \"Erasmus+ Placement\", \"Magalhães\", \"Bilateral Agreement\", \"Visiting Student\", \"SICUE/SENECA\", \"Traineeship\", \"Research Stay/Project\", \"Other\"]"
